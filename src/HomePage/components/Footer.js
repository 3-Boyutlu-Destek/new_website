  ...
  return (
    <footer className="Footer">
        ...
        <div className="Footer-top">
          <div className="Footer-top-left">
            <a href="/" className="Footer-top-left-link">
              <img src="logo.svg" className="Footer-top-left-link-img" alt="Ana Sayfa"></img>
            </a>
          ...
          <div className="Footer-top-middle">
            <div className="Footer-top-middle-links">
              <div className="Footer-top-middle-links-left">
                ...
                <a href="kvkk_metni.html" className="Footer-top-middle-links-left-link" target="_blank">
                  Kişisel Verisi İşlenen (İlgili Kişi) Başvuru Formu
                </a>
                <a href="aydinlatma_metni.html" className="Footer-top-middle-links-left-link" target="_blank">
              ...
              <div className="Footer-top-middle-links-right">
                ...
                <a href="ss_sorular.html" className="Footer-top-middle-links-right-link" target="_blank">
                  S.S.S
                </a>
                <a href="" className="Footer-top-middle-links-right-link">
                  Blog
          ...
          <div className="Footer-top-right">
            <p className="Footer-top-right-text">Bizi Sosyal Medyada Takip Edin</p>
            <div className="Footer-top-right-social">
              ...
              <a href="http://instagram.com/3BoyutluDestek/" target="_blank" className="Footer-top-right-social-link">
      ...
      <div className="Footer-bottom">
        <p>Copyright 3 Boyutlu Destek | Kollektif Üretim Hareketi Platformu Tüm Hakkı Saklıdır. | 2020</p>
      </div>
    </footer>
  );
}
